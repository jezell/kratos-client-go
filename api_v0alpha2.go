...
To forcefully logout Identity from all devices and sessions
	...
	AdminLookupIdentity(ctx context.Context, id string) V0alpha2ApiApiAdminLookupIdentityRequest
	AdminLookupIdentityExecute(r V0alpha2ApiApiAdminLookupIdentityRequest) (*Identity, *http.Response, error)
...
type V0alpha2ApiApiAdminLookupIdentityRequest struct {
	ctx        context.Context
	ApiService V0alpha2Api
	email      string
}

func (r V0alpha2ApiApiAdminLookupIdentityRequest) Execute() (*Identity, *http.Response, error) {
 ...
 */
func (a *V0alpha2ApiService) AdminLookupIdentity(ctx context.Context, email string) V0alpha2ApiApiAdminLookupIdentityRequest {
	return V0alpha2ApiApiAdminLookupIdentityRequest{
		ApiService: a,
		ctx:        ctx,
		email:      email,
	}
 ...
 * @return Identity
 */
func (a *V0alpha2ApiService) AdminLookupIdentityExecute(r V0alpha2ApiApiAdminLookupIdentityRequest) (*Identity, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
