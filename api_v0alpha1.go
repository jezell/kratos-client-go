...
type V0alpha1Api interface {
	...
	*/
	...
	AdminLookupIdentity(ctx context.Context, id string) V0alpha1ApiApiAdminLookupIdentityRequest
	AdminLookupIdentityExecute(r V0alpha1ApiApiAdminLookupIdentityRequest) (*Identity, *http.Response, error)
...
type V0alpha1ApiApiAdminLookupIdentityRequest struct {
	ctx        context.Context
	ApiService V0alpha1Api
	email      string
}

func (r V0alpha1ApiApiAdminLookupIdentityRequest) Execute() (*Identity, *http.Response, error) {
	return r.ApiService.AdminLookupIdentityExecute(r)
}
 ...
 * @return V0alpha1ApiApiAdminGetIdentityRequest
 */
func (a *V0alpha1ApiService) AdminLookupIdentity(ctx context.Context, email string) V0alpha1ApiApiAdminLookupIdentityRequest {
	return V0alpha1ApiApiAdminLookupIdentityRequest{
		ApiService: a,
		ctx:        ctx,
		email:      email,
	}
 ...
 * @return Identity
 */
func (a *V0alpha1ApiService) AdminLookupIdentityExecute(r V0alpha1ApiApiAdminLookupIdentityRequest) (*Identity, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/identity-lookup/{email}"
